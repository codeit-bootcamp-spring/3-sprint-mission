...
//        userService.getAllUsers().forEach(u -> System.out.println(u.getName()));
    ...
    public static void menuMain(){
        while (true) {
            ...
            switch (choice) {
                case 1:
                    System.out.println(" ▶ 1번 메뉴는 아직 미지원입니다.\n ");
                    //            menuEnterChannel();
                    break;
                case 2:
...
//    public static void menuMessageMng(User currentUser){       // 1_1 채널 조작 메서드
//
//        while (true) {
//            System.out.println(" *******************************************************\n"
...
//                        if(userService.chkExistName(newName)){
...
//                    System.out.println(" ▶ 3번 메뉴는 아직 미지원입니다.\n ");
//                    //            menuChannelMng();
//                    break;
