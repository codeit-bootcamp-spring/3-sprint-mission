...
public class UserController {
    ...
    /* 유저 생성 */
    @RequestMapping(path = "/users", method = RequestMethod.POST, consumes = {MediaType.MULTIPART_FORM_DATA_VALUE})
    @ResponseBody
    ...
    /* 유저 수정 */
    @RequestMapping(path = "/users/update/{userId}", method = RequestMethod.PUT, consumes = {MediaType.APPLICATION_JSON_VALUE, MediaType.MULTIPART_FORM_DATA_VALUE})
    @ResponseBody
...
//            @RequestParam String userId,
    ...
    public ResponseEntity<UserStatus> updateStatus(
        ...
        UserStatus userStatus = userStatusService.updateByUserId(parseStringToUuid(userId), userUpdateRequest);
