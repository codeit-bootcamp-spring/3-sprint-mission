...
import com.sprint.mission.discodeit.utility.PasswordValidator;
...
public class UserController {
    ...
    public ResponseEntity<?> create(
            // @RequestPart : 하나 일 때는 value 생략 가능, 다수일 경우 이후부터 value 필요
    ...
    public ResponseEntity<User> update(
        ...
        User updatedUser = userService.update(userId, userUpdateRequest, Optional.ofNullable(profile).flatMap(this::resolveProfileRequest));
    ...
    public ResponseEntity<?> updateByPass(
            @PathVariable UUID userId
            , @RequestPart("userPasswordUpdateRequest") UserPasswordUpdateRequest userPasswordUpdateRequest
    ) {
