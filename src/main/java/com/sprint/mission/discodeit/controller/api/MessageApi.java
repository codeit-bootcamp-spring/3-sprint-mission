...
public interface MessageApi {
        ...
        @ApiResponses(value = {
                        ...
                        @ApiResponse(responseCode = "404", description = "Channel 또는 Author를 찾을 수 없음", content = @Content(examples = @ExampleObject("Channel | Author with id {channelId | authorId} not found")))
        })
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "Message 내용이 성공적으로 수정됨", content = @Content(schema = @Schema(implementation = MessageDto.class))),
        ...
        @Operation(summary = "Channel의 모든 Message 조회 (커서 페이징 지원)")
        @ApiResponses(value = {
        ...
        ResponseEntity<PageResponse<MessageDto>> findAllByChannelId(
                        ...
                        @Parameter(description = "페이징 커서 정보 (date-time)") String cursor,
