...
public class BinaryContentController {
  ...
  @Parameter(name = "binaryContentIds", description = "조회할 첨부파일 ID목록")
  ...
  @Parameter(name = "binaryContentId", description = "조회할 첨부파일 ID")
  @GetMapping(value = "/binaryContents/{binaryContentId}")
