...
public class ReadStatusController {
    ...
    public ResponseEntity<ReadStatus> createReadStatus(
        ...
        return ResponseEntity.created(URI.create(createdReadStatus.getId().toString())).body(createdReadStatus);
    }
    ...
    public ResponseEntity<ReadStatus> update(
        ...
        ReadStatus updatedReadStatus = readStatusService.update(parseStringToUuid(readStatusId), readStatusUpdateRequest);
