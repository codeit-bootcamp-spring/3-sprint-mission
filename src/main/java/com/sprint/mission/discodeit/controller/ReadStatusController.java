...
public class ReadStatusController {
    ...
    @RequestMapping(path = "/find/{readStatusId}", method = RequestMethod.GET)
    @ResponseBody
    ...
    @ResponseBody
    public ResponseEntity<List<ReadStatusResponseDTO>> findByUserId(@PathVariable UUID userId) {
    ...
    @RequestMapping(path = "/delete/{readStatusId}", method = RequestMethod.DELETE)
    @ResponseBody
