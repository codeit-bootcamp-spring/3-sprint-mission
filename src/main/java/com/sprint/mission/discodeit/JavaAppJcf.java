...
public class JavaAppJcf {
    ...
    public static final ChannelService channelService = new JcfChannelService();
    public static final MessageService messageService = new JcfMessageService(userService, channelService);
