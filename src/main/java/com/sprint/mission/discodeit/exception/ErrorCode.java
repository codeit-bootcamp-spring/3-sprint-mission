...
public enum ErrorCode {
    ...
    USER_EMAIL_ALREADY_EXISTS(409, "U002", "이미 존재하는 이메일입니다."),
    USER_NAME_ALREADY_EXISTS(409, "U003", "이미 존재하는 이름입니다."),
    USER_WRONG_PASSWORD(401, "U004", "비밀번호가 올바르지 않습니다."),

    CHANNEL_NOT_FOUND(404, "C001", "채널을 찾을 수 없습니다."),
    PRIVATE_CHANNEL_UPDATE_FORBIDDEN(403, "C002", "비공개 채널은 수정할 수 없습니다."),
