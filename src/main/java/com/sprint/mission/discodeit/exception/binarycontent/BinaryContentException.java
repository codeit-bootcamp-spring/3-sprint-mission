...
/**
 * 바이너리 콘텐츠 도메인 관련 예외의 기본 클래스
 * 바이너리 콘텐츠와 관련된 모든 예외는 이 클래스를 상속받습니다.
 */
public abstract class BinaryContentException extends DiscodeitException {
   ...
   * 모든 필드를 받는 생성자
   */
  protected BinaryContentException(Instant timestamp, ErrorCode errorCode, Map<String, Object> details) {
