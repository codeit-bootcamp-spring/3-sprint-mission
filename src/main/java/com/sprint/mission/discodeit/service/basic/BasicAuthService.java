...
public class BasicAuthService implements AuthService {
  ...
  public JwtInformation refreshToken(String refreshToken) {
    ...
    try {
      String newAccessToken = tokenProvider.createAccessToken(userDetails.getUsername());
      String newRefreshToken = tokenProvider.createRefreshToken(userDetails.getUsername());
