...
public class ServiceFactory {
  ...
  public static void initializeServices() {
    FileUserService user = new FileUserService(userStatusRepository);  //  먼저 Jcf(File)UserService를 비워서 생성한다.
    channelService = new FileChannelService(user,messageRepository); // Jcf(File)ChannelService에 유저서비스를 넣는다.
