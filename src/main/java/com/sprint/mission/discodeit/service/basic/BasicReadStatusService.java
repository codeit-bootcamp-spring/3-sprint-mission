        ...
        return readStatusRepository.findById(readStatusId)
            ...
            .orElseThrow(
                () -> new ReadStatusNotFoundException(ErrorCode.READ_STATUS_NOT_FOUND,
                    Map.of("조회 시도한 읽기 상태 ID 정보", readStatusId)));
    }
