...
public class JavaApplication3 {
    public static void main(String[] args) {
        // JCF*Repository 구현체 활용 테스트
        System.out.println("-------------------JCF*Repository-------------------");
        UserService basicUserService = new BasicUserService(new JCFUserRepository());
        ...
        // 채널 등록
        ChannelService basicChannelService = new BasicChannelService(new JCFChannelRepository(), basicUserService);
        ...
        // 메시지 등록
        MessageService basicMessageService = new BasicMessageService(new JCFMessageRepository(), basicUserService,
                basicChannelService);
