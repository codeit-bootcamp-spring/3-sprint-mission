...
public class JavaApplication2 {
    public static void main(String[] args) {
        ...
        // 해당 채널에 있던 User의 channelList에 반영됐는지 확인
        System.out.println("----------------------------");
        System.out.println("Channel1에 속해있던 user1의 채널리스트 확인: ");
        userService.findById(user1.getId()).ifPresent(user -> {
            System.out.println(user.getChannels());
        });

        System.out.println("----------------------------");
        System.out.println("Channel2에 속해있던 user2의 채널리스트 확인: ");
        userService.findById(user2.getId()).ifPresent(user -> {
            System.out.println(user.getChannels());
        });
        // Channel 삭제
        ...
        System.out.println("----------------------------");
        System.out.println("Channel5에 속해있던 user3의 channelList 확인");
        userService.findById(user3.getId()).ifPresent(user -> {
            System.out.println(user.getChannels());
        });
        ...
        Message message3 = new Message("Hi", user1, channel3);
        Message message4 = new Message("Thank you", user2, channel4);
        ...
        // Message를 보낸 user와 Message가 있는 channel에서 변경 사항 확인
        System.out.println("----------------------------");
        System.out.println("Message를 보낸 User, 메시지가 있는 채널의 messageList 확인");

        userService.findById(user3.getId()).ifPresent(user -> {
            System.out.println(user.getMessages());
        });
        System.out.println("----------------------------");
        channelService.findById(channel3.getId()).ifPresent(channel -> {
        ...
        // 조회를 통해 삭제 되었는지 확인
        System.out.println("----------------------------");
        System.out.println("Message4 삭제 확인: ");
        messageService.findAll().forEach(System.out::println);
