...
public class FileBinaryContentRepository implements BinaryContentRepository {
    private static final Path DIRECTORY = Paths.get(System.getProperty("user.dir"), "data", "binaryContent");
    ...
    public static BinaryContent load(Path filePath) {
    ...
    public void deleteByUserId(UUID userId) throws IOException {
        ...
        Files.delete(Paths.get(String.valueOf(DIRECTORY), binaryContent.getId()+".ser"));
    }
}
