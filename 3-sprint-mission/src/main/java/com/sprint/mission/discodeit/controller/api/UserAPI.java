...
@Tag(name = "User", description = "User API") // Tag: API를 그룹화. 보통 Controller 클래스 단위로 정의
public interface UserAPI {

  @Operation(summary = "User 등록") // Operation: 엔드포인트에 대한 설명
  @ApiResponses(value = {
      @ApiResponse(
  ...
  ResponseEntity<UserDto> create(
      @Parameter( // Parameter: 요청 파라미터에 대한 설명
